 ...
 * Date: Aug 29, 2015			
 *
 * Describe: Add new food type (food category)
 *				
...
public class FoodTypeAddAction extends Action {
    @Override
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		// Get new food type infor from input form
		FoodForm foodForm = (FoodForm) form;
		FoodTypeBO foodTypeBO = new FoodTypeBO();
		String foodTypeName = foodForm.getFoodTypeNew();

		// Insert new food type
		foodTypeBO.insertFoodType(foodTypeName);
